    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-8">
            <div className="text-center space-y-2">
                <h2 className="text-3xl font-bold text-gray-900">Compress Image</h2>
                <p className="text-gray-500">Reduce file size of JPG, PNG, and WEBP images while maintaining quality.</p>
            </div>
                ...
                {!downloadUrl ? (
                                ...
                                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 space-y-6">
                                    <div className="flex p-1 bg-gray-200/50 rounded-xl mb-6">
                                        <button
                                            ...
                                            className={clsx(
                                                ...
                                                compressionMode === 'quality' ? "bg-white text-brand-navy shadow-sm" : "text-gray-500 hover:text-gray-700"
                                            )}
                                        >
                                            Quality Mode
                                        </button>
                                        <button
                                            ...
                                            className={clsx(
                                                "flex-1 py-1.5 text-[13px] font-bold rounded-lg transition-all",
                                                compressionMode === 'size' ? "bg-white text-brand-navy shadow-sm" : "text-gray-500 hover:text-gray-700"
                                            )}
                                        >
                                            Target Size
                                        </button>
                                    ...
                                    {compressionMode === 'quality' ? (
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center">
                                                <label className="text-lg font-bold text-gray-900">Compression Level</label>
                                        ...
                                        <div className="space-y-4">
                                            <label className="text-lg font-bold text-gray-900">Set Maximum Size</label>
                                            <div className="flex gap-2">
                                                <input
                                                    type="number"
                                                    value={targetSize}
                                                    onChange={(e) => setTargetSize(e.target.value)}
                                                    className="flex-1 px-4 py-3 rounded-xl border border-gray-200 focus:ring-4 focus:ring-brand-navy/10 focus:border-brand-navy transition-all outline-none font-bold text-brand-navy"
                                                    placeholder="Enter size..."
                                                />
                                                <select
                                                    value={targetUnit}
                                                    onChange={(e) => setTargetUnit(e.target.value)}
                                                    className="px-4 py-3 rounded-xl border border-gray-200 focus:ring-4 focus:ring-brand-navy/10 focus:border-brand-navy transition-all outline-none font-bold text-brand-navy bg-white"
                                                >
                                                    <option>KB</option>
                                                    <option>MB</option>
                                                </select>
                                            </div>
                                            <p className="text-xs text-gray-500">The app will attempt to compress the image to be under this size.</p>
                                        </div>
                                    )}
                                    ...
                                    <div className="mt-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm min-h-[64px] flex items-center justify-center">
                                        {estimating ? (
                                            ...
                                            <p className="text-xs text-gray-400">Enter a target size to see estimation</p>
                                        )}
                                    </div>
                                </div>
                    ...
                    <div className="text-center space-y-6 py-10">
                        ...
                        <div>
                            ...
                            {stats && (
                                <div className="mt-4 flex items-center justify-center gap-4 bg-green-50 px-6 py-3 rounded-xl border border-green-100">
                        ...
                        <div className="flex flex-col gap-4 max-w-sm mx-auto">
                            <a
                                ...
                                className="px-8 py-3 bg-brand-navy text-white rounded-xl font-semibold shadow-lg shadow-brand-navy/20 hover:bg-brand-navy/90 transition-colors flex items-center justify-center gap-2"
                            >
