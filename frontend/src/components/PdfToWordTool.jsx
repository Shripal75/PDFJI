    ...
    return (
        <div className="max-w-6xl mx-auto p-6 space-y-8">
            <div className="text-center space-y-2">
                ...
                <p className="text-gray-500 dark:text-gray-400">Convert PDF documents (or specific pages) to editable Word (.docx) format.</p>
            </div>
                ...
                {!downloadUrl ? (
                                                ...
                                                <div
                                                    ...
                                                    className={clsx(
                                                        ...
                                                        selectedPages.has(i)
                                                            ...
                                                            : "border-gray-200 dark:border-slate-600 hover:border-gray-300 hover:shadow-md"
                                                    )}
                                                >
                                        ...
                                        <div className="p-4 bg-gray-50 dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-700">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <input
                                                    ...
                                                    className="flex-grow px-4 py-2 border border-gray-200 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-navy/20"
                                                />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="text-center space-y-6 py-10">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400 mt-2">Your PDF has been converted to Word.</p>
                        </div>
